...
namespace Final_Project_Brady {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentTableDataTable : global::System.Data.TypedTableBase<StudentTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentTableRow AddStudentTableRow(int StudentID, string FirstName, string LastName, string Class, System.DateTime Date, string Present) {
        ...
        public partial class StudentTableRow : global::System.Data.DataRow {
            ...
            public System.DateTime Date {
                get {
                    return ((global::System.DateTime)(this[this.tableStudentTable.DateColumn]));
                }
                set {
                    this[this.tableStudentTable.DateColumn] = value;
                }
            }
            ...
            public string Present {
                get {
                    return ((string)(this[this.tableStudentTable.PresentColumn]));
                }
                set {
                    this[this.tableStudentTable.PresentColumn] = value;
                }
            }
        }
...
namespace Final_Project_Brady.StudentDataSetTableAdapters {
    ...
    public partial class StudentTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[StudentTable] WHERE (([StudentID] = @Original_StudentID) AND (" +
                ...
                "lass] = @Original_Class) AND ([Date] = @Original_Date) AND ([Present] = @Origina" +
                "l_Present))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[StudentTable] ([StudentID], [FirstName], [LastName], [Class], [Date], [Present]) VALUES (@StudentID, @FirstName, @LastName, @Class, @Date, @Present);
SELECT StudentID, FirstName, LastName, Class, Date, Present FROM StudentTable WHERE (StudentID = @StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[StudentTable] SET [StudentID] = @StudentID, [FirstName] = @FirstName, [LastName] = @LastName, [Class] = @Class, [Date] = @Date, [Present] = @Present WHERE (([StudentID] = @Original_StudentID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Class] = @Original_Class) AND ([Date] = @Original_Date) AND ([Present] = @Original_Present));
SELECT StudentID, FirstName, LastName, Class, Date, Present FROM StudentTable WHERE (StudentID = @StudentID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Final_Project_Brady.Properties.Settings.Default.StudentConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, FirstName, LastName, Class, Date, Present FROM dbo.StudentTable" +
                "";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT StudentID, FirstName, LastName, Class, Date, Present FROM dbo.StudentTable" +
        ...
        public virtual int TodaysAttendance(StudentDataSet.StudentTableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_StudentID, string Original_FirstName, string Original_LastName, string Original_Class, System.DateTime Original_Date, string Original_Present) {
            ...
            if ((Original_Present == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_Present));
            }
        ...
        public virtual int Insert(int StudentID, string FirstName, string LastName, string Class, System.DateTime Date, string Present) {
        ...
        public virtual int Update(int StudentID, string FirstName, string LastName, string Class, System.DateTime Date, string Present, int Original_StudentID, string Original_FirstName, string Original_LastName, string Original_Class, System.DateTime Original_Date, string Original_Present) {
            ...
            if ((Original_Present == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_Present));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Class, System.DateTime Date, string Present, int Original_StudentID, string Original_FirstName, string Original_LastName, string Original_Class, System.DateTime Original_Date, string Original_Present) {
            return this.Update(Original_StudentID, FirstName, LastName, Class, Date, Present, Original_StudentID, Original_FirstName, Original_LastName, Original_Class, Original_Date, Original_Present);
        }
    }
